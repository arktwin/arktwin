...
FROM sbtscala/scala-sbt:eclipse-temurin-25.0.1_8_1.12.4_3.8.2 AS jar-build
WORKDIR /arktwin/
...
COPY --from=jar-build /arktwin/center/target/scala-3.8.2/arktwin-center.jar /opt/arktwin/arktwin-center.jar
