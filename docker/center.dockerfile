...
FROM sbtscala/scala-sbt:eclipse-temurin-21.0.5_11_1.10.7_3.6.3 AS jar-build
...
COPY --from=jar-build /arktwin/center/target/scala-3.6.3/arktwin-center.jar /opt/arktwin/arktwin-center.jar
