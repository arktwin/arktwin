...
FROM sbtscala/scala-sbt:eclipse-temurin-21.0.7_6_1.11.2_3.7.1 AS jar-build
...
COPY --from=jar-build /arktwin/center/target/scala-3.7.1/arktwin-center.jar /opt/arktwin/arktwin-center.jar
