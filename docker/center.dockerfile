...
FROM sbtscala/scala-sbt:eclipse-temurin-21.0.7_6_1.11.4_3.7.2 AS jar-build
WORKDIR /arktwin/
...
COPY --from=jar-build /arktwin/center/target/scala-3.7.2/arktwin-center.jar /opt/arktwin/arktwin-center.jar
