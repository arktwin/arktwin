...
FROM sbtscala/scala-sbt:eclipse-temurin-25.0.3_9_1.12.11_3.8.4 AS jar-build
WORKDIR /arktwin/
...
COPY --from=jar-build /arktwin/center/target/scala-3.8.4/arktwin-center.jar /opt/arktwin/arktwin-center.jar
EXPOSE 2236
